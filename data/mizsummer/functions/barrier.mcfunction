...
summon panda ~ ~ ~ {NoAI:1b,ActiveEffects:[{Id:14b,Duration:2000000,ShowParticles:false}],Tags:["shield"],Team:"escape",Silent:1b,Health:20f}
tellraw @s [{"text":"結界を展開した！","color":"green"}]
particle minecraft:enchant ~ ~ ~ 1 1 1 0 25 normal
effect give @s resistance 10 0 true
effect give @e[type=panda] resistance 10 0 true
